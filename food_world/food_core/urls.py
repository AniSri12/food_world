...
urlpatterns = [
    ...
    url(r'^users/update/(?P<pk>\d+)', views.updateUser, name = "update_users"),
    url(r'^snacks/update/(?P<pk>\d+)', views.updateSnack, name = "update_snacks"),
    url(r'^carts/update/(?P<pk>\d+)', views.updateCart, name = "update_carts"),
    url(r'^wishlists/update/(?P<pk>\d+)', views.updateWishlist, name = "update_users"),
